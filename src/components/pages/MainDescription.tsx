...
const MainDescription = () => {
  return (
    <section id="main-description" className="MainDescription my-5 p-20">
      ...
      {/* Section heading */}
      <h2 className="text-center font-bold text-primary text-2xl">¿Por qué es tan GENIAL?</h2>
      <hr className="horizontal-rule" />

      {/* Section description */}
      <p className="text-center font-medium mx-auto mb-20">
      ...
      <div className="MainDescription__focus">
        ...
        <div className="description-grid">
          <div className="item-grid">
            <i className="fas fa-share fa-lg text-primary" />
            <h5 className="font-bold">Misión</h5>
            <p className="!text-[18px] pb-6">Desarrollar soluciones integrales basadas en medios tecnológicos, innovadores,
          ...
          <div className="item-grid">
            ...
            <p className="!text-[18px] pb-6">Ser reconocido por la sociedad como el equipo referente de P.I. de la UNITEC para las
          ...
          <div className="item-grid">
            ...
            <p className="!text-[18px] pb-6">Conformar un equipo multidisciplinario, que basado en las ultimas tecnologias pueda
